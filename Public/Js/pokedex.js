...
document.addEventListener('click', e => {
    ...
    if (e.target.id === $iconFav.id) {
        let $conteinerLength = 3,
            $text = e.target.previousSibling.textContent,
            img = e.target.parentElement.parentElement.children[1]
        fav($text, img, $conteinerLength)
    }   
})
